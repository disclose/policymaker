...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:image', property: 'og:image', content: 'https://policymaker.disclose.io/og-card.jpg' },
      ...
      { hid: 'twitter:image', name: 'twitter:image', content: 'https://policymaker.disclose.io/og-card.jpg' },
    ],
    link: [
